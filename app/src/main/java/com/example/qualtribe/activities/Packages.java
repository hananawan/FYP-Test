...
public class Packages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonX = findViewById(R.id.cont);
        inbox = findViewById(R.id.btn_inbox);

        Log.d(Constants.TAG, "onCreate Packages: " + getIntent().getStringExtra(Constants.KEY_USER_ID));

        inbox.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Packages.this, chat.class);
        ...
        buttonX.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Packages.this, Contract.class);
                startActivity(intent);
            }
        });
        ...
        ordr.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String sellerId = getIntent().getStringExtra(Constants.KEY_USER_ID);
                Intent intent = new Intent(Packages.this, payment.class);
                intent.putExtra("PRICE", price);
                intent.putExtra("PKGDESC", pkgDesc);
                intent.putExtra(Constants.KEY_USER_ID, sellerId);
                startActivity(intent);
